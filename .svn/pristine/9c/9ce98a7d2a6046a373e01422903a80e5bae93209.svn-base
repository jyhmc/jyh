...
//	alias : 'widget.uploadPanel',
	...
	columns : [
		...
		}},
        {
            ...
            width:50,
            items: [{
                icon: __ctxPath+'/Ext42/ux/uploadPanel/icons/delete.gif',
                tooltip: 'Remove',
	...
	post_params : {},
	upload_url : 'test.do',
	flash_url : __ctxPath+"/Ext42/ux/uploadPanel/swfupload/swfupload.swf",
	flash9_url : __ctxPath+"/Ext42/ux/uploadPanel/swfupload/swfupload_fp9.swf",
