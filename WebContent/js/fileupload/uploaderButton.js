...
Ext.define('UploadButtonPanel', {
		...
		me.listeners = {
			'afterrender' : function() {
				...
				swfupload = new SWFUpload({
							...
							button_height : buttonelm.getHeight(),
							button_placeholder_id : placeHolderId,
							// 属性，解决this指向
							upload_url : me.uploadUrl,
							// flash_url : this.flashUrl,
							file_size_limit : me.fileSize || (1024*1024* 50),// 上传文件体积上限，单位MB
							file_post_name : me.filePostName,
							file_types : me.file_types, // 允许上传的文件类型
							file_types_description : "All Files", // 文件类型描述
							file_upload_limit : me.file_upload_limit||"10000", // 限定用户一次性最多上传多少个文件，在上传过程中，该数字会累加，如果设置为“0”，则表示没有限制
							...
							// this.onDialogStart,
							// file_dialog_start_handler : function() {// 开始上传时
							// Ext.ux.Toast.msg('tt', '开始上传aaa');
	...
	onUploadSuccess : function(file, serverData, responseReceived) {
		...
		// // ok
		// }
		me.fireEvent("onUploadSuccess", me, file, serverData, responseReceived);
	},
