...
function getChallenge()
{
	var challenge = sendRequest("Auth.servlet?func=getChallenge");
	return ""+challenge+"";
}
...
{	
	var authCode;
	authCode = sendRequest("ConfigInfo.servlet?data=AuthCode");
	return ""+authCode+"";
}
...
{
	var vendorID;
	vendorID = sendRequest("ConfigInfo.servlet?data=VendorID");
	return ""+vendorID+"";
}
...
function getFactor()
{
	var factor = sendRequest("ConfigInfo.servlet?data=Factor");
	return ""+factor+"";
}
...
{
	var ret = sendRequest("Auth.servlet?func=Authentication&dogid="+dogid+"&result="+result+"");
	return ret;
}
